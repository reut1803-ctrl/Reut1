  ...
  return (
    <>
      <button
        ...
        className="fixed top-1/2 z-50 flex h-12 w-8 -translate-y-1/2 items-center justify-center rounded-r-none rounded-l-xl bg-[#C06E5E] text-white shadow-lg transition-[right] duration-300"
      >
      ...
      >
        <div className="p-5">
          <div className="mb-4 flex items-center gap-1.5">
            <Tag size={16} className="text-[#C06E5E]" />
            <h2 className="text-[15px] font-bold text-[#5A4A3C]">סינון לפי תווית</h2>
          </div>
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    color: tag.textColor,
                    boxShadow: active ? "0 0 0 2px #5A4A3C" : "none",
                  }}
          ...
          {activeTag && (
            <button
              ...
              className="mt-4 w-full rounded-2xl border border-[#EADCCB] py-2.5 text-[13px] font-semibold text-[#5A4A3C] transition hover:bg-[#FBF3EA]"
            >
              ניקוי סינון
            </button>
          )}
