  ...
  return (
    <>
      ...
      <div className="rounded-3xl border border-[#CFE3EC] bg-white p-4 shadow-[0_4px_18px_rgba(58,51,53,0.06)]">
        <p className="text-[13px] leading-relaxed text-[#5E7A87]">
        ...
        <p
          dir="ltr"
          className="mt-3 truncate rounded-2xl bg-[#F2F8FB] px-3 py-2.5 text-left text-[12px] text-[#23414E]"
        >
          {url || "..."}
        </p>
        ...
        <div className="mt-2 flex gap-2">
          ...
          <a
            ...
            className="flex flex-1 items-center justify-center gap-1.5 rounded-2xl border border-[#CFE3EC] bg-white px-3 py-2.5 text-[13px] font-semibold text-[#23414E] transition active:scale-95"
          >
        ...
        {nameIndexState === "denied" ? (
          <div className="mt-3 flex items-start gap-2 rounded-2xl border-2 border-[#C4584C] bg-red-50 px-3 py-2.5">
            <AlertTriangle size={15} className="mt-0.5 shrink-0 text-[#C4584C]" />
            <p className="text-[12px] leading-relaxed font-semibold text-[#C4584C]">
          ...
          <p className="mt-3 rounded-2xl bg-[#DDE6DF] px-3 py-2.5 text-[12px] font-semibold leading-relaxed text-[#21867F]">
            הבדיקה לפי שם פעילה. מי שכבר במאגר יימצא בטופס ויוכל לעדכן את הסטטוס שלו.
          </p>
        ) : nameIndexState === "running" ? (
          <p className="mt-3 rounded-2xl bg-[#F2F8FB] px-3 py-2.5 text-[12px] text-[#5E7A87]">
