...
export default function GoogleSignInButton({ label = "המשך עם חשבון Google" }) {
  ...
  return (
    <div>
      <button
        onClick={handleClick}
        className="flex w-full items-center justify-center gap-2.5 rounded-full border border-[#DADCE0] bg-white px-4 py-2.5 text-sm font-semibold text-[#5A4A3C] shadow-sm transition active:scale-95 hover:bg-[#FBF3EA]"
      >
