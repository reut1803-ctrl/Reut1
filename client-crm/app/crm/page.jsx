...
function ProfilesFeed() {
  ...
  return (
    <div className="px-4 py-4">
      ...
      {candidatesError ? (
        <p className="mt-16 text-center text-sm leading-relaxed text-[#C4584C]">
        ...
        <>
          {hiddenByFilters > 0 && (
            <div className="mt-3 flex items-center justify-between gap-2 rounded-2xl border border-[#F0E3C0] bg-[#FDF6EC] px-3 py-2">
              ...
              <button
                onClick={clearAllFilters}
                className="shrink-0 rounded-xl bg-[#8A6A32] px-2.5 py-1.5 text-[11px] font-bold text-white transition active:scale-95"
              >
                ניקוי סינון
              </button>
            </div>
