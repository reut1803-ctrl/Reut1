...
export default function FavoritesPage() {
  ...
  return (
    <div className="px-4 py-4">
      <h1 className="mb-4 text-xl font-bold text-[#23414E]">מועדפים</h1>

      {favCandidates.length === 0 ? (
        <div className="mt-10 flex flex-col items-center text-center">
          <div className="mb-3 flex h-16 w-16 items-center justify-center rounded-full bg-[#DCEEF5]">
            <Heart size={28} className="text-[#A8D8E8]" />
          </div>
          <p className="text-sm font-semibold text-[#23414E]">עדיין אין לך מועדפים</p>
          <p className="mt-1 text-[13px] text-[#5E7A87]">לחצי על סמל הלב בכרטיסייה כדי לשמור אותה כאן</p>
        </div>
      ) : (
