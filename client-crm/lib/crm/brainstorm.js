...
//
// כל שאלה כתובה פעמיים, בלשון זכר ובלשון נקבה. לא ניסינו להמיר לשון
// אוטומטית: בעברית זה נוגע כמעט בכל מילה במשפט ("הוא צריך" מול "היא
// צריכה", "עבורו" מול "עבורה", "יוותר" מול "תוותר"), וכל טעות קטנה
// בולטת מיד וקוראת רע. שתי גרסאות כתובות ביד הן הדרך היחידה שבה
// השאלה נשמעת טבעית בשני המקרים.
export const QUESTION_BANK = [
  ...
  {
    male: "לאיזו משפחה הוא צריך להיכנס כדי להרגיש בבית?",
    female: "לאיזו משפחה היא צריכה להיכנס כדי להרגיש בבית?",
  },
  {
...
// השאלות בלשון שמתאימה למועמד/ת שנבחרו. בלי מגדר ידוע - לשון זכר,
// כפי שהיה עד כה.
export const questionsFor = (gender) =>
  QUESTION_BANK.map((q) => (gender === "female" ? q.female : q.male));
