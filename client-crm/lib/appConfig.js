...
export const APP_SUBTITLE = "מאגרי שידוכים דבורה אליסה לדרמן";
export const APP_SHORT_NAME = "אור בהירות הדרך";
export const APP_TAGLINE = "מיזם להקמת בתים בישראל";

// השם המלא, כפי שהוא מופיע בכותרת הדפדפן ובתצוגה המקדימה של הקישור
// בוואטסאפ וברשתות. מוגדר פעם אחת כאן, כדי ששני המקומות לא ייפרדו.
export const APP_FULL_TITLE = `${APP_NAME} - ${APP_SUBTITLE}`;

export const APP_DESCRIPTION =
  "מאגרי שידוכים דבורה אליסה לדרמן – ניהול מועמדים, הצעות שידוך ומשימות צוות";
...
// --- עלויות ותשלום ---
// ההצטרפות למאגר אינה כרוכה בתשלום. "המסלול האישי" הוא שירות נוסף
// ואופציונלי: שיחת היכרות מעמיקה לדיוק החיפוש.
export const PERSONAL_TRACK_PRICE = 60;

// דמי הצלחה, משולמים רק אם וכאשר נישאים. מוצג בהסכם ההתקשרות.
export const SUCCESS_FEE = 2500;

// אמצעי התשלום. כל עוד שניהם ריקים, מוצג במקומם הסבר שפרטי התשלום
// יימסרו בשיחה - כך המסך נשאר תקין ולא מציג כפתור שבור.
export const PAYBOX_URL = "";
export const BIT_PHONE = "";
