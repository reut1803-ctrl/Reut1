...
import { buildActivityIndex } from "./attention";
...
export const useCrmStore = create((set, get) => ({
  ...
  // --- מפת הפעילות על מועמדים ---
  // "פעולה אחרונה" על מועמד/ת אינה רק עריכת הכרטיס שלו/ה: כניסה להצעת שידוך,
  // שינוי שלב בהצעה (כולל "ירד מהפרק") ועלייה לסיעור מוחות הן טיפול לכל דבר.
  // המפה נבנית מהנתונים שכבר נטענו למסך, ולכן היא נכונה גם רטרואקטיבית -
  // על כל ההצעות והסבבים שנוצרו לפני שהחיווי הזה בכלל היה קיים.
  // היא נבנית מחדש בכל עדכון של אחד האוספים, ולא בזמן ציור המסך.
