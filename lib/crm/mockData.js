...
export const CANDIDATE_TAGS = [
  { name: "תורני", color: "#2A1605", textColor: "#FFFFFF" },
  { name: 'דתל"שים ומסורתיים', color: "#331D07", textColor: "#FFFFFF" },
  { name: 'חב"ד', color: "#5B3418", textColor: "#FFFFFF" },
  { name: "ברסלב", color: "#B8860B", textColor: "#2E2116" },
  { name: "פרק ב'", color: "#E0C478", textColor: "#2E2116" },
];
