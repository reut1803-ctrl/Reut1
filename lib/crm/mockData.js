...
export const CANDIDATE_TAGS = [
  { name: "תורני", color: "#3D2814", textColor: "#FFFFFF" },
  { name: 'דתל"שים ומסורתיים', color: "#4E3220", textColor: "#FFFFFF" },
  { name: 'חב"ד', color: "#6F4A2E", textColor: "#FFFFFF" },
  { name: "ברסלב", color: "#C9A227", textColor: "#3B332A" },
  { name: "פרק ב'", color: "#EBD79A", textColor: "#3B332A" },
];
