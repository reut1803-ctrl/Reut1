...
const YESHIVA_TERMS = {
  ...
  "הסדר": ["הסדר", "ישיבת הסדר"],
  "צבא": ["צבא", "צה\"ל", "צהל", "שירות צבאי", "קרבי", "לוחם"],
  "עובד ולומד": ["עובד ולומד"],
  "עובד": ["עובד"],
  "תואר ראשון": ["תואר ראשון", "ב.א", "בוגר"],
  "תואר שני": ["תואר שני", "מ.א", "מוסמך"],
  "תעודה": ["תעודה", "הנדסאי", "מקצועי"],
};
...
const EDUCATION_TERMS = {
  ...
  "מדרשה": ["מדרשה"],
  "סמינר": ["סמינר"],
  "שירות": ["שירות לאומי", "בת שירות", "שנת שירות", "שירות"],
  "תואר ראשון": ["תואר ראשון", "ב.א", "בוגרת"],
  "תואר שני": ["תואר שני", "מ.א", "מוסמכת"],
  "עובדת ולומדת": ["עובדת ולומדת"],
  "עובדת": ["עובדת"],
};
...
export function parseCandidateText(rawText, gender = "male") {
  ...
  if (!text.trim()) return { fields: {}, traits: [], lifestyle: [], found: [], negated: [] };
  ...
  if (gender === "female") {
    put(
      "education",
      pickFromDictionary(text, EDUCATION_TERMS, EDUCATION_OPTIONS, MILITARY_NEGATIONS) ||
        labeledValue(text, LABELS.education)
    );
  } else {
    put(
      "yeshivaLevel",
      pickFromDictionary(text, YESHIVA_TERMS, YESHIVA_LEVELS, MILITARY_NEGATIONS) ||
        labeledValue(text, LABELS.yeshivaLevel)
    );
  }
  ...
  return { fields, traits, lifestyle, found, negated: Array.from(new Set(negated)) };
}
