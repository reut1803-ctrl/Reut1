...
const LABELS = {
  ...
  currentOccupation: ["עיסוק נוכחי", "עיסוק", "עובד כ", "עובדת כ", "מקצוע", "תפקיד"],
...
export function parseCandidateText(rawText, gender = "male") {
  ...
  // עיסוק נוכחי נשלף מתווית מפורשת בלבד - אחרת זה ניחוש
  put("currentOccupation", labeledValue(text, LABELS.currentOccupation));
  ...
  if (occupations.length) found.push("המסלול שלי");
