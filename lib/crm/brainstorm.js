...
//
// לכל שאלה שתי גרסות כתובות מראש - לשון זכר ולשון נקבה - והמערכת
// בוחרת לפי המגדר של הכרטיס שעליו נפתח הסבב.
//
// למה שתי גרסאות כתובות ולא המרה אוטומטית של הטקסט: העברית אינה
// ניתנת להטייה בטוחה באמצעות החלפת מילים. "הוא לא יוותר" הופך ל"היא לא
// תוותר" - פועל שלם משתנה, לא רק כינוי הגוף. מנגנון המרה "חכם" היה
// מייצר משפטים שבורים. עשר שאלות קבועות - עדיף לנסח אותן נכון פעם אחת.
//
// בדרך אגב נפתרות גם הלוכסנים המגושמים ("אותו/אותה", "בן/בת זוג"):
// כשיודעים על מי מדברים, השאלה נקראת כמו משפט שנאמר בעל פה.
export const QUESTION_BANK = [
  {
    male: "הפער בין איך שהוא מציג את עצמו למה שהוא באמת צריך הוא...",
    female: "הפער בין איך שהיא מציגה את עצמה למה שהיא באמת צריכה הוא...",
  },
  {
    male: "הדבר שהכי עלול להפחיד אותו בזוגיות הוא כנראה...",
    female: "הדבר שהכי עלול להפחיד אותה בזוגיות הוא כנראה...",
  },
  {
    male: "אם היינו צריכים לתאר את סביבת החיים האידיאלית עבורו ב-3 מילים, הן היו...",
    female: "אם היינו צריכים לתאר את סביבת החיים האידיאלית עבורה ב-3 מילים, הן היו...",
  },
  {
    male: "איזה סגנון של בת זוג יוציא ממנו את המיטב, ואיזה סגנון עלול 'לכבות' אותו?",
    female: "איזה סגנון של בן זוג יוציא ממנה את המיטב, ואיזה סגנון עלול 'לכבות' אותה?",
  },
  {
    male: "נקודת העיוורון שלו (מה שהוא לא רואה על עצמו) היא...",
    female: "נקודת העיוורון שלה (מה שהיא לא רואה על עצמה) היא...",
  },
  {
    male: "הצענו לו בעבר הצעה שלא עבדה. המסקנה האמיתית מזה היא ש...",
    female: "הצענו לה בעבר הצעה שלא עבדה. המסקנה האמיתית מזה היא ש...",
  },
  {
    male: "מה הדבר שהוא לא יוותר עליו בשום מצב, גם אם לא אמר אותו במפורש?",
    female: "מה הדבר שהיא לא תוותר עליו בשום מצב, גם אם לא אמרה אותו במפורש?",
  },
  {
    male: "איזו משפחה הוא צריך להיכנס אליה כדי להרגיש בבית?",
    female: "איזו משפחה היא צריכה להיכנס אליה כדי להרגיש בבית?",
  },
  {
    male: "מה הכוח הכי גדול שלו שדווקא לא בולט בכרטיס?",
    female: "מה הכוח הכי גדול שלה שדווקא לא בולט בכרטיס?",
  },
  {
    male: "אם הוא היה יושב מולנו עכשיו, מה היינו רוצים לשאול אותו ולא שאלנו?",
    female: "אם היא הייתה יושבת מולנו עכשיו, מה היינו רוצים לשאול אותה ולא שאלנו?",
  },
];

// פונקציית העזר המרכזית: ניסוח השאלה לפי מגדר הכרטיס.
// ברירת המחדל היא לשון זכר, כפי שהיה עד היום, כל עוד לא נבחר/ה מועמד/ת.
// מקבלת גם מחרוזת רגילה, כדי ששאלות שנשמרו בסבבים קודמים ימשיכו לעבוד.
export function questionText(entry, gender) {
  if (!entry) return "";
  if (typeof entry === "string") return entry;
  return gender === "female" ? entry.female : entry.male;
}

// מאגר השאלות מנוסח למגדר אחד, מוכן לתצוגה.
export function questionBankFor(gender) {
  return QUESTION_BANK.map((entry) => questionText(entry, gender));
}
