...
// הכותרת שמופיעה בתצוגה המקדימה כששולחים את הקישור (וואטסאפ, פייסבוק).
// היא נפרדת בכוונה מהטקסטים שמוצגים בתוך המסכים, כדי שאפשר יהיה לנסח
// אותה לשיתוף בלי לשנות את הכיתוב במסך הכניסה ובלוגו.
export const SHARE_TITLE = "אדמה מאגר השידוכים לחוות וגבעות";
