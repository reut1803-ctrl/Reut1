...
export function initStore() {
  ...
  initialized = true;
  // התחברות אנונימית כדי שניתן יהיה לקבוע כללי אבטחה שמאפשרים גישה רק דרך האפליקציה.
  // אם ההתחברות לא זמינה עדיין - ממשיכים בכל מקרה (תאימות לאחור).
...
export async function updateCandidate(id, patch) {
  return updateDoc(doc(db, "candidates", id), patch);
}
