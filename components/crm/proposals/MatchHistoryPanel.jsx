  ...
  return (
    <li className="flex items-center justify-between gap-2 rounded-2xl bg-white px-3 py-2.5">
      <div className="min-w-0">
        <p className="truncate text-[13px] font-semibold text-[#3A3335]">
          {maleName} ⚭ {femaleName}
        </p>
        <p className="mt-0.5 text-[11px] text-[#B5AEB0]">
      ...
      <div className="flex shrink-0 items-center gap-1">
        <button
          ...
          className="rounded-full p-1.5 text-[#8C4A55] transition hover:bg-[#F6E4E6]"
        ...
        {role === "admin" && (
          <button
            ...
            className="rounded-full p-1.5 text-[#C24545] transition hover:bg-red-50"
...
export default function MatchHistoryPanel() {
  ...
  return (
    <div className="mt-6 rounded-3xl border border-[#EAE5E3] bg-[#F6F5F4] p-3">
      <button
        type="button"
        onClick={() => setOpen((v) => !v)}
      ...
      >
        <span className="flex items-center gap-1.5 text-[13px] font-bold text-[#3A3335]">
          <Archive size={15} className="text-[#8C4A55]" />
        ...
        <div className="mt-3 space-y-4">
          {isAdmin && (
            <div className="rounded-2xl border border-[#EAE5E3] bg-white p-3">
              <p className="text-[12px] font-bold text-[#3A3335]">הזנת התאמה מהעבר</p>
              ...
              <input
                ...
                className="mt-2 w-full rounded-xl border border-[#EAE5E3] bg-white px-3 py-2.5 text-[13px] outline-none focus:border-[#8C4A55]"
              />

              {alreadyExists && (
                <p className="mt-2 rounded-xl bg-[#FFF8E7] px-3 py-2 text-[11px] font-semibold text-[#946200]">
          ...
          <div>
            <p className="mb-2 text-[12px] font-semibold text-[#3A3335]">הרשומות ששמורות בהיסטוריה</p>
            {dropped.length === 0 ? (
              <p className="rounded-2xl bg-white px-3 py-4 text-center text-[12px] text-[#8A8285]">
