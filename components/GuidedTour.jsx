...
const TOUR_STEPS = [
  ...
  { element: '[data-tour="gender"]', title: "סינון מהיר: בנים / בנות", intro: "סינון מהיר: כאן תוכלו לסנן את רשימת «מועמדים קודמים» ולהציג רק בחורים או רק בחורות בלחיצת כפתור, כדי לחסוך זמן." },
