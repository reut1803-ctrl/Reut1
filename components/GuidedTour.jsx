...
const TOUR_STEPS = [
  ...
  { element: '[data-tour="candviews"]', title: "חדשים / קודמים", intro: "«מועמדים חדשים» מציג את המצטרפים האחרונים; «מועמדים קודמים» מציג את שאר המאגר." },
  { element: '[data-tour="add"]', title: "הוספת מועמד", intro: "כאן מוסיפים מועמד חדש וממלאים את הפרטים והשאלון." },
  { element: '[data-tour="tip"]', title: "טיפ בשידוכים", intro: "טיפ יומי שמתחלף, לעזרה בעבודת השידוכים." },
  { element: '[data-tour="nav-candidates"]', title: "מועמדים", intro: "רשימת המועמדים - לחיצה על כרטיס פותחת את כל הפרטים." },
  { element: '[data-tour="nav-matches"]', title: "התאמות", intro: "כאן יוצרים ומנהלים הצעות התאמה בין מועמדים, כולל נימוק ומעקב." },
